...
var _initShowApproval = require("./modules/init-show-approval");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _initShowApproval.initShowApproval)();
  });
});
...
},{"./modules/form-validate/form":3,"./modules/init-show-approval":9,"./utils/ios-vh-fix":11}],2:[function(require,module,exports){
"use strict";
...
exports.initShowApproval = void 0;
var formBtn = document.querySelector('.form__btn');
var rules = document.querySelector('.feedback__rules');
var initShowApproval = function initShowApproval() {
...
//   }
// };
exports.initShowApproval = initShowApproval;
